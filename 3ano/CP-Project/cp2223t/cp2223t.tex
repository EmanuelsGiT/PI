...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;((\Varid{f0},\Varid{f1}),\Varid{f2})\mathrel{=}((\Varid{c}\mathbin{*}\Varid{f2}\mathbin{+}\Varid{b}\mathbin{*}\Varid{f1}\mathbin{+}\Varid{a}\mathbin{*}\Varid{f0},\Varid{f0}),\Varid{f1}){}\<[E]%
\\
...
\\
\>[B]{}\Varid{gene}\;(\Varid{x}\mathbin{:}\Varid{xs})\mid \Varid{a}\equiv \mathrm{1}\mathrel{=}i_1\;\Varid{x}{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mid \Varid{otherwise}\mathrel{=}i_2\;(\Varid{x},\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{b}\mathrel{=}\Varid{divide}\;\Varid{xs}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{a}\mathrel{=}\length \;(\Varid{head}\;(\Varid{divide}\;(\Varid{x}\mathbin{:}\Varid{xs}))){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{divide}\mathrel{=}\Varid{groupBy}\;(\lambda \Varid{x}\;\Varid{y}\to \Varid{countSpaces}\;\Varid{x}\mathbin{<}\Varid{countSpaces}\;\Varid{y}){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{countSpaces}\mathrel{=}\length \comp \Varid{takeWhile}\;(\equiv \text{\ttfamily '~'}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{post}\;\Varid{et}\mathrel{=}\Varid{nub}\;(\Varid{g}\;\Varid{l1}\;l_2 ){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{l1}\mathrel{=}\map \;\p1\mathbin{\$}\Varid{zip}\;(\Varid{nub}\;(\map \;\p1\;(\Varid{tar}\;\Varid{et})))\;(\map \;\p2\;(\Varid{tar}\;\Varid{et})){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}l_2 \mathrel{=}\map \;(\lambda (\Varid{a},\Varid{b})\to \Varid{a}\mathbin{+\!\!\!+}[\mskip1.5mu \Varid{b}\mskip1.5mu])\;(\Varid{tar}\;\Varid{et}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{g}\mathbin{::}\Conid{Eq}\;\Varid{a}\Rightarrow [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{g}\;\Varid{l}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Varid{l}{}\<[E]%
\\
\>[B]{}\Varid{g}\;[\mskip1.5mu \mskip1.5mu]\;\Varid{l}\mathrel{=}\Varid{l}{}\<[E]%
\\
\>[B]{}\Varid{g}\;(\Varid{a}\mathbin{:}\Varid{b})\;(\Varid{c}\mathbin{:}\Varid{d})\mid \Varid{isPrefixOf}\;\Varid{a}\;\Varid{c}\mathrel{=}(\Varid{tail}\;(\Varid{inits}\;\Varid{a}))\mathbin{+\!\!\!+}[\mskip1.5mu \Varid{c}\mskip1.5mu]\mathbin{+\!\!\!+}\Varid{g}\;\Varid{b}\;\Varid{d}{}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\mid \Varid{otherwise}\mathrel{=}[\mskip1.5mu \Varid{c}\mskip1.5mu]\mathbin{+\!\!\!+}\Varid{g}\;(\Varid{a}\mathbin{:}\Varid{b})\;\Varid{d}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment squares :: (Square, Int) -> Rose Square}{}\<[E]%
\\
\>[B]{}\Varid{squares}\mathrel{=}\lanabracket\;\!\Varid{gsq}\;\!\ranabracket_\textit{\tiny R}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gsq}\;(\Varid{s}\mathord{@}((\Varid{x},\Varid{y}),\Varid{l}),\Varid{n})\mathrel{=}(((\Varid{x}\mathbin{+}\Varid{l}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\Varid{l}\mathbin{/}\mathrm{3}),\Varid{l}\mathbin{/}\mathrm{3}),\Varid{singular}\;(\Varid{s},\Varid{n})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{singular}\;(((\Varid{x},\Varid{y}),\Varid{l}),\Varid{n})\mathrel{=}{}\<[37]%
\>[37]{}[\mskip1.5mu (((\Varid{a},\Varid{b}),\Varid{l}\mathbin{/}\mathrm{3}),\Varid{n}\mathbin{-}\mathrm{1})\mid \Varid{b}\leftarrow [\mskip1.5mu \Varid{y},\Varid{y}\mathbin{+}\Varid{l}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}(\Varid{l}\mathbin{/}\mathrm{3})\mskip1.5mu],\Varid{a}\leftarrow [\mskip1.5mu \Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}(\Varid{l}\mathbin{/}\mathrm{3}),\Varid{x}\mathbin{+}\Varid{l}\mathbin{/}\mathrm{3},\Varid{x}\mskip1.5mu],(\Varid{a},\Varid{b})\not\equiv (\Varid{x}\mathbin{+}\Varid{l}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\Varid{l}\mathbin{/}\mathrm{3}),\Varid{n}\mathbin{>}\mathrm{0}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment rose2List :: Rose a -> [a]}{}\<[E]%
\\
\>[B]{}\Varid{rose2List}\mathrel{=}\llparenthesis\, \Varid{gr2l}\,\rrparenthesis_\textit{\tiny R}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gr2l}\mathrel{=}(\lambda (\Varid{x},\Varid{l})\to \Varid{x}\mathbin{:}(\Varid{concat}\;\Varid{l})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{carpets}\mathbin{::}\Conid{Int}\to [\mskip1.5mu [\mskip1.5mu \Conid{Square}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{carpets}\mathrel{=}\ana{\cdot }\mathbin{\$}((\Varid{f}\comp \underline{\mathbin{-}\mathrm{1}})+\conj{\Varid{f}}{\Varid{id}})\comp \Varid{outNat}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{f}\;\Varid{n}\mathrel{=}\Varid{sierpinski}\;(((\mathrm{0},\mathrm{0}),\mathrm{32}),\Varid{n}\mathbin{+}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{present}\mathbin{::}[\mskip1.5mu [\mskip1.5mu \Conid{Square}\mskip1.5mu]\mskip1.5mu]\to \fun{IO}\;[\mskip1.5mu ()\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{present}\mathrel{=}\llparenthesis\, \cdot \,\rrparenthesis\mathbin{\$}\alt{\Varid{return}\comp \Varid{nil}}{\mathsf{fmap}\;\Varid{cons}\comp \Varid{dstr}\comp (\Varid{f}\times\Varid{id})}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{f}\;\Varid{x}\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{v}\leftarrow \Varid{drawSq}\;\Varid{x};\Varid{await}\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
